/*RoundsPanel.java
The panel that displays options for number of rounds
...
public class RoundsPanel extends JPanel
{
     ...
     * @param scale
     */
    public RoundsPanel(int width, int height, int scale)
    {
        this.width = width;
        this.height = height;
        this.scale = scale;
    ...
    /**
     * Creates the title for the rounds panel
     */
    public void paintTitle()
    {
        //Setting up colour and font
        g2d.setColor(Color.BLACK);
        Font font = new Font("Serif", Font.ITALIC, width / 10);
        FontRenderContext frc = g2d.getFontRenderContext();
        //Display text
        GlyphVector gv = font.createGlyphVector(frc, "Number of Rounds");
        g2d.drawGlyphVector(gv, width / 2 - ((int) gv.getVisualBounds().getWidth() / 2), height * 2 / 5 - ((int) gv.getVisualBounds().getHeight() / 2));
    }//end of method

    /**
     * Creates the subtitles for the number of rounds
     */
    public void paintRounds()
    {
        //Setting up colour and font
        ...
        GlyphVector gv = font.createGlyphVector(frc, "1 - 1 Round");
        g2d.drawGlyphVector(gv, width / 2 - ((int) gv.getVisualBounds().getWidth() / 2), height * 5 / 10 - ((int) gv.getVisualBounds().getHeight() / 2));
        gv = font.createGlyphVector(frc, "2 - 2 Rounds");
        g2d.drawGlyphVector(gv, width / 2 - ((int) gv.getVisualBounds().getWidth() / 2), height * 6 / 10 - ((int) gv.getVisualBounds().getHeight() / 2));
        gv = font.createGlyphVector(frc, "3 - 3 Rounds");
        g2d.drawGlyphVector(gv, width / 2 - ((int) gv.getVisualBounds().getWidth() / 2), height * 7 / 10 - ((int) gv.getVisualBounds().getHeight() / 2));
        gv = font.createGlyphVector(frc, "4 - 4 Rounds");
        g2d.drawGlyphVector(gv, width / 2 - ((int) gv.getVisualBounds().getWidth() / 2), height * 8 / 10 - ((int) gv.getVisualBounds().getHeight() / 2));
        gv = font.createGlyphVector(frc, "5 - 5 Rounds");
        g2d.drawGlyphVector(gv, width / 2 - ((int) gv.getVisualBounds().getWidth() / 2), height * 9 / 10 - ((int) gv.getVisualBounds().getHeight() / 2));
    }//end of method
